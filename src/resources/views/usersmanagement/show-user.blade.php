      ...
      <div class="col-md-10 col-md-offset-1">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            ...
            <a href="/admin/users/" class="btn btn-primary btn-xs pull-right">
          ...
          <div class="panel-footer">
            <div class="row">
              <div class="col-xs-6">
                <a href="/admin/users/{{$user->id}}/edit" class="btn btn-small btn-info btn-block">
              ...
              {!! Form::open(array('url' => '/admin/users/' . $user->id, 'class' => 'col-xs-6')) !!}
